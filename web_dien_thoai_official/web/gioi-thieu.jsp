<%-- 
    Document   : gioi-thieu
    Created on : Jun 21, 2022, 6:01:19 AM
    Author     : daotr
--%>
        ...
        <div class="phan3">
                    ...
                    <form name="formlh" onsubmit="return nguoidung()">
                        <table cellspacing="10px">
                            <tr>
                                ...
                                <td><input style="padding: 6px 5px;" type="text" name="ht" size="40" maxlength="40" placeholder="Họ tên"
                                        autocomplete="off" required></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;">Điện thoại liên hệ</td>
                                <td><input style="padding: 6px 5px;" type="text" name="sdt" size="40" maxlength="11" minlength="10"
                                        placeholder="Điện thoại" required ></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;">Địa chỉ Email</td>
                                <td><input style="padding: 6px 5px;" type="email" name="em" size="40" placeholder="Email" autocomplete="off" required>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;">Tiêu đề</td>
                                <td><input style="padding: 6px 5px;" type="text" name="tde" size="40" maxlength="100" placeholder="Tiêu đề" required>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;">Nội dung</td>
                                <td><textarea style="padding: 6px 5px;" name="nd" rows="5" cols="44" maxlength="500" wrap="physical"
            ...
            <div class="thongtinnhom">
                ...
                <table class="tb" border="5">
                    ...
                    <script>
                        var thongtin = [
                            ["Nguyễn Quang Trường", "B19DCCN703", "Nam", "D19CQCN12-B",],
                            ["Nguyễn Hoàng Việt  ", "B19DCCN714", "Nam", "D19CQCN12-B",],
                            ["Nguyễn Thị Phương  ", "B19DCCN513", "Nữ ", "D19CQCN09-B",],
                            ["Đào Trọng Phúc     ", "B19DCCN504", "Nam", "D19CQCN12-B",],
