...
<body>
    ...
    <div class="main-body">
        <form action="dangky" class="form-login" id="form-1">
            <div class="form-content">
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <input id="email" name="name" type="text" placeholder="VD: Nguyễn Văn A" class="form-control" onblur="isRequired('#email')">
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group">
                        <label for="email" class="form-label">Email</label>
                        <input id="email" name="mail" type="text" placeholder="VD: nguyena@gmail.com" class="form-control" onblur="isRequired('#email')">
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group">
                        <label for="email" class="form-label">Số điện thoại</label>
                        <input id="email" name="Sdt" type="text" placeholder="VD: 012345678" class="form-control" onblur="isRequired('#email')">
                        <span class="form-message"></span>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-footer">
                    <button type="submit" class="form-submit" onclick="validate()">ĐĂNG KÝ</button>
                </div>
