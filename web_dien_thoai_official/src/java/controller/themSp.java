 ...
 * @author QUYTVM
 */
@WebServlet(name = "themSp", urlPatterns = {"/them"})
public class themSp extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String slug = request.getParameter("motahinhanh");
            ...
            //SanPham a = cdb.layTheoTen(tenSP);
//            if(a!=null){
//                String tendn = tenSP + " existed!!!";
//                request.setAttribute("eror", tendn);
...
//            }else{
                ...
                HinhAnh anh = new HinhAnh(0,0,path,slug,df.format(new Date()));                
                ...
                SanPham a1 = new SanPham(0,tenSP,hang,id1,id2,id3,cpu,kthuoc,camtrc,camsa,id4,l,df.format(new Date()),df.format(new Date()));
                cdb.themSanPham(a1);
                response.sendRedirect("sanphamAdmin.jsp");
                String tendn = "them thanh cong!!!";
                request.setAttribute("eror", tendn);                
//        } catch(IOException e){
